                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.blog.category') }}" method="POST">
                            ...
                            @csrf
                            <input type="hidden" name="id" value="{{ $editBlogCateogry->id }}">

                            <div class="row mb-3">
                                <label for="" class="col-sm-2 col-form-label">Blog Cateogry Name</label>

                                <div class="col-sm-10">
                                    <input type="text" name="blog_category" value="{{ $editBlogCateogry->blog_category }}" class="form-control" placeholder="">
                                    @error('blog_category')
